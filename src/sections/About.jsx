...
import {AnimatedHeaderSection, AnimatedTextLines} from '../components';
...
const About = () => {
	...
	apps-from pixel-perfect React UIs to bulletproof serverless backends.
